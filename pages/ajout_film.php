                ...
                <div class="container">
                    <form action="traitementajout.php" id="form-login" method="POST" enctype="multipart/form-data">
                        <div class="text-center">
                            ...
                            <div class="mb-5">
                                <label for="scenariste_film" class="form-label">
                                    Scenariste
                                </label>
                                <textarea class="form-control" rows="5" id="scenariste_film" name="scenariste_film" required></textarea>
                            </div>
                            ...
                            <div class="mb-5">
                                <label for="duree_film" class="form-label">
                                    Duree
                                </label>
                                <textarea class="form-control" rows="5" id="duree_film" name="duree_film" required></textarea>
                            </div>
